   ...
   $options[] = array(
    ...
    if ( class_exists( 'WooCommerce' ) ) {
        ...
        $options[] =    array(
            ...
            'transport'   => 'postMessage',
            'post_js'     => '$(".site-header-section .aux-cart-wrapper .aux-shopping-basket").alterClass( "aux-action-on-*", "aux-action-on-" + to ); $(".site-header-section").AuxshpDropdownEffect();',
            'choices'     => array(
    ...
    if ( class_exists( 'WooCommerce' ) ) {
        ...
        $options[] =    array(
            ...
            'transport'   => 'postMessage',
            'post_js'     => '$(".aux-top-header .aux-cart-wrapper .aux-shopping-basket").alterClass( "aux-action-on-*", "aux-action-on-" + to ); $(".aux-top-header").AuxshpDropdownEffect();',
            'choices'     => array(
                'hover'     => __( 'Hover', 'phlox' ),
                'click'     => __( 'Click', 'phlox' )
            ),
